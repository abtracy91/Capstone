...
class ThresholdsControllerTest < ActionController::TestCase
  ...
  test "should create threshold" do
    assert_difference('Threshold.count') do
      post :create, threshold: { thresholdSpeed: @threshold.thresholdSpeed, thresholdTemperature: @threshold.thresholdTemperature, thresholdWeight: @threshold.thresholdWeight }
    end
  ...
  test "should update threshold" do
    put :update, id: @threshold, threshold: { thresholdSpeed: @threshold.thresholdSpeed, thresholdTemperature: @threshold.thresholdTemperature, thresholdWeight: @threshold.thresholdWeight }
    assert_redirected_to threshold_path(assigns(:threshold))
  end
